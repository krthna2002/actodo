                ...
                props.list.length !== 0 ?
                    props.list.map((item, index) =>
                        <div className="flex flex-row justify-between items-center" key={index}>
                            <h1 className="font-semibold">{++index}. {item.task}</h1>
                            <button onClick={() => props.handleRemove(item.id)} className="hover:bg-violet-900 text-yellow-400 p-3 rounded-full font-bold">
